...
plt.savefig(dest + 'accuracy_GR_w_fixed_3classes_' + dim_argmax + '_' + name + '_0'  '.png',bbox_inches='tight')
plt.savefig(dest + 'accuracy_GR_w_fixed_3classes_' + dim_argmax + '_' + name + '_0'  '.svg',bbox_inches='tight')
mpl.rcParams.update(mpl.rcParamsDefault)
...
ax.bar3d(xpos, ypos, zpos, dx, dy, dz*100 , color=barcolors.to_rgba(dz),alpha = 0.9, zsort='average')
ax.locator_params(axis='z',nbins=nbins)
plt.savefig(dest + 'accuracy_AR_w_fixed_3classes_' + dim_argmax + '_' + name + '_0'  '.png',bbox_inches='tight')
plt.savefig(dest + 'accuracy_AR_w_fixed_3classes_' + dim_argmax + '_' + name + '_0'  '.svg',bbox_inches='tight')
mpl.rcParams.update(mpl.rcParamsDefault)
...
ax.bar3d(xpos, ypos, zpos, dx, dy, dz*100 , color=barcolors.to_rgba(dz),alpha = 0.9, zsort='average')
ax.locator_params(axis='z',nbins=nbins)
plt.savefig(dest + 'accuracy_GR_w_fixed_2classes_' + dim_argmax + '_' + name + '_0'  '.png',bbox_inches='tight')
plt.savefig(dest + 'accuracy_GR_w_fixed_2classes_' + dim_argmax + '_' + name + '_0'  '.svg',bbox_inches='tight')
mpl.rcParams.update(mpl.rcParamsDefault)
...
ax.bar3d(xpos, ypos, zpos, dx, dy, dz*100 , color=barcolors.to_rgba(dz),alpha = 0.9, zsort='average')
ax.locator_params(axis='z',nbins=nbins)
plt.savefig(dest + 'accuracy_AR_w_fixed_2classes_' + dim_argmax + '_' + name + '_0'  '.png',bbox_inches='tight')
plt.savefig(dest + 'accuracy_AR_w_fixed_2classes_' + dim_argmax + '_' + name + '_0'  '.svg',bbox_inches='tight')
mpl.rcParams.update(mpl.rcParamsDefault)
...
plt.savefig(dest + 'accuracyL1_GR_3classes_' + dim_argmax + '_' + name + '_0'  '.png',bbox_inches='tight')
plt.savefig(dest + 'accuracyL1_GR_3classes_' + dim_argmax + '_' + name + '_0'  '.svg',bbox_inches='tight')
mpl.rcParams.update(mpl.rcParamsDefault)
...
ax.set_ylabel('Accuracy [$\\%$]', fontsize = 18)
ax.set_xlabel('$s$', fontsize = 18)
plt.savefig(dest + 'accuracyL1_AR_3classes_' + dim_argmax + '_' + name + '_0'  '.png',bbox_inches='tight')
plt.savefig(dest + 'accuracyL1_AR_3classes_' + dim_argmax + '_' + name + '_0'  '.svg',bbox_inches='tight')
mpl.rcParams.update(mpl.rcParamsDefault)

...
plt.savefig(dest + 'accuracy_GR_w_fixed_3classes_' + dist[dist_index] + '_' + name + '_'  '.png',bbox_inches='tight')
plt.savefig(dest + 'accuracy_GR_w_fixed_3classes_' + dist[dist_index] + '_' + name + '_'  '.svg',bbox_inches='tight')
mpl.rcParams.update(mpl.rcParamsDefault)
...
ax.locator_params(axis='z',nbins=nbins)
ax.set_zticklabels(map(int,offset +  ax.get_zticks()))
plt.savefig(dest + 'accuracy_AR_w_fixed_3classes_' + dist[dist_index] + '_' + name + '_'  '.png',bbox_inches='tight')
plt.savefig(dest + 'accuracy_AR_w_fixed_3classes_' + dist[dist_index] + '_' + name + '_'  '.svg',bbox_inches='tight')
mpl.rcParams.update(mpl.rcParamsDefault)
...
ax.locator_params(axis='z',nbins=nbins)
ax.set_zticklabels(map(int,offset +  ax.get_zticks()))
plt.savefig(dest + 'accuracy_GR_w_fixed_2classes_' + dist[dist_index] + '_' + name + '_'  '.png',bbox_inches='tight')
plt.savefig(dest + 'accuracy_GR_w_fixed_2classes_' + dist[dist_index] + '_' + name + '_'  '.svg',bbox_inches='tight')
mpl.rcParams.update(mpl.rcParamsDefault)
...
ax.locator_params(axis='z',nbins=nbins)
ax.set_zticklabels(map(int,offset +  ax.get_zticks()))
plt.savefig(dest + 'accuracy_AR_w_fixed_2classes_' + dist[dist_index] + '_' + name + '_'  '.png',bbox_inches='tight')
plt.savefig(dest + 'accuracy_AR_w_fixed_2classes_' + dist[dist_index] + '_' + name + '_'  '.svg',bbox_inches='tight')
mpl.rcParams.update(mpl.rcParamsDefault)
...
plt.savefig(dest + 'accuracyL1_GR_3classes_' + dist[dist_index] + '_' + name + '_'  '.png',bbox_inches='tight')
plt.savefig(dest + 'accuracyL1_GR_3classes_' + dist[dist_index] + '_' + name + '_'  '.svg',bbox_inches='tight')
mpl.rcParams.update(mpl.rcParamsDefault)
...
ax.set_xlabel('$s$', fontsize = 18)
ax.set_yticklabels(map(int,offset +  ax.get_yticks()))
plt.savefig(dest + 'accuracyL1_AR_3classes_' + dist[dist_index] + '_' + name + '_'  '.png',bbox_inches='tight')
plt.savefig(dest + 'accuracyL1_AR_3classes_' + dist[dist_index] + '_' + name + '_'  '.svg',bbox_inches='tight')
mpl.rcParams.update(mpl.rcParamsDefault)
...
ax.set_xlabel('$s$', fontsize = 18)
ax.set_yticklabels(map(int,offset +  ax.get_yticks()))
plt.savefig(dest + 'accuracyL1_GR_2classes_' + dist[dist_index] + '_' + name + '_'  '.png',bbox_inches='tight')
plt.savefig(dest + 'accuracyL1_GR_2classes_' + dist[dist_index] + '_' + name + '_'  '.svg',bbox_inches='tight')
mpl.rcParams.update(mpl.rcParamsDefault)
...
ax.set_xlabel('$s$', fontsize = 18)
ax.set_yticklabels(map(int,offset +  ax.get_yticks()))
plt.savefig(dest + 'accuracyL1_AR_2classes_' + dist[dist_index] + '_' + name + '_'  '.png',bbox_inches='tight')
plt.savefig(dest + 'accuracyL1_AR_2classes_' + dist[dist_index] + '_' + name + '_'  '.svg',bbox_inches='tight')
mpl.rcParams.update(mpl.rcParamsDefault)

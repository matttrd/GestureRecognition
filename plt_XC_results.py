...
plt.savefig(dest + 'accuracy_GR_2classes_' + dist[dist_index] + '_' + name + '_'  '.png',bbox_inches='tight')
plt.savefig(dest + 'accuracy_GR_2classes_' + dist[dist_index] + '_' + name + '_'  '.svg',bbox_inches='tight')
...
ax.set_xlabel('$s$', fontsize = 18)
ax.set_yticklabels(map(int,offset +  ax.get_yticks()))
plt.savefig(dest + 'accuracy_AR_2classes_' + dist[dist_index] + '_' + name + '_'  '.png',bbox_inches='tight')
plt.savefig(dest + 'accuracy_AR_2classes_' + dist[dist_index] + '_' + name + '_'  '.svg',bbox_inches='tight')
mpl.rcParams.update(mpl.rcParamsDefault)
...
ax.set_xlabel('$s$', fontsize = 18)
ax.set_yticklabels(map(int,offset +  ax.get_yticks()))
plt.savefig(dest + 'accuracy_GR_2classes_' +dim_argmax + '_' + name + '_'  '.png',bbox_inches='tight')
plt.savefig(dest + 'accuracy_GR_2classes_' +dim_argmax + '_' + name + '_'  '.svg',bbox_inches='tight')
mpl.rcParams.update(mpl.rcParamsDefault)
...
ax.set_xlabel('$s$', fontsize = 18)
ax.set_yticklabels(map(int,offset +  ax.get_yticks()))
plt.savefig(dest + 'accuracy_AR_2classes_' +dim_argmax + '_' + name + '_'  '.png',bbox_inches='tight')
plt.savefig(dest + 'accuracy_AR_2classes_' +dim_argmax + '_' + name + '_'  '.svg',bbox_inches='tight')
mpl.rcParams.update(mpl.rcParamsDefault)

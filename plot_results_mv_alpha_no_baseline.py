...
ax.bar3d(xpos, ypos, zpos, dx, dy, dz*100, color=barcolors.to_rgba(dz),alpha = 1, zsort='average')
...
ax.azim = -62
ax.elev = 22
plt.savefig(dest + 'accuracy_GR_alpha_fixed_3classes_' + dist[dist_index] + '_0.png',bbox_inches='tight')
plt.savefig(dest + 'accuracy_GR_alpha_fixed_3classes_' + dist[dist_index] + '_0.svg',bbox_inches='tight')
mpl.rcParams.update(mpl.rcParamsDefault)
...
ax.locator_params(axis='z',nbins=nbins)
plt.savefig(dest + 'accuracy_AR_alpha_fixed_3classes_' + dist[dist_index] + '_0.png',bbox_inches='tight')
plt.savefig(dest + 'accuracy_AR_alpha_fixed_3classes_' + dist[dist_index] + '_0.svg',bbox_inches='tight')
mpl.rcParams.update(mpl.rcParamsDefault)
...
ax.bar3d(xpos, ypos, zpos, dx, dy, dz*100, color=barcolors.to_rgba(dz),alpha = 0.9, zsort='average')
ax.locator_params(axis='z',nbins=nbins)
plt.savefig(dest + 'accuracy_GR_alpha_fixed_2classes_' + dist[dist_index] + '_0.png',bbox_inches='tight')
plt.savefig(dest + 'accuracy_GR_alpha_fixed_2classes_' + dist[dist_index] + '_0.svg',bbox_inches='tight')
mpl.rcParams.update(mpl.rcParamsDefault)
...
ax.bar3d(xpos, ypos, zpos, dx, dy, dz*100, color=barcolors.to_rgba(dz),alpha = 0.9, zsort='average')
ax.locator_params(axis='z',nbins=nbins)
plt.savefig(dest + 'accuracy_AR_alpha_fixed_2classes_' + dist[dist_index] + '_0.png',bbox_inches='tight')
plt.savefig(dest + 'accuracy_AR_alpha_fixed_2classes_' + dist[dist_index] + '_0.svg',bbox_inches='tight')
mpl.rcParams.update(mpl.rcParamsDefault)
